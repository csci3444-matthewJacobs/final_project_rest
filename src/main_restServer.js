...
// app.use('/teacher', teacherRestRouter); // NOTE ilker important - make sure body-parser is specified before router. Otherwise you get undefined request.body in router
